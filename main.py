...
# List for plots:
k_values = [10*i for i in range(25)]
k_values[0] = 1
...
plt.plot(k_values, RMSE_values_train, label="Training RMSE", color='r')
...
plt.plot(k_values, accuracy_values_train, label="Training accuracy", color='r')
